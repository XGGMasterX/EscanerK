...
class Stock : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnUp  = findViewById(R.id.btnUpStock)
        btnDown  = findViewById(R.id.btnDownStock)
        btnAdd = findViewById(R.id.btnAddStock)
        btnEscanear = findViewById(R.id.btnEscanearStock)
        btnFlash = findViewById(R.id.btnFlashStock)
        textNombre = findViewById(R.id.TextNombreStock)
        textCode = findViewById(R.id.TextCodeStock)
        textCantidad  = findViewById(R.id.TextCantidadStock)
        //blue 0 , 182 , 255
        //red  252,99,134
        //yellow 229,218,1
        ...
        val btnWeb: Button = findViewById(R.id.btnWebStock)
        val btnStock: Button = findViewById(R.id.btnStock)
        val btnListar: Button = findViewById(R.id.btnListarStock)
